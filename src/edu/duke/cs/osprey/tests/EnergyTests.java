...
public class EnergyTests {
	...
	public static void test1CC8Energy() {
		// compute the full energy for 1CC8 using the default AMBER forcefield,
		// and compare it to OSPREY 2 values
		...
		// Compare to correct energies (assuming default settings), calculated
		// with OSPREY 2
		double correctE;
