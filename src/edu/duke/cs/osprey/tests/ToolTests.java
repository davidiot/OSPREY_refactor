...
public class ToolTests {
	...
	public static void RigidMotionTest() {
		// Take 3 random points in 3-D, apply a random rigid motion to them,
		...
		RigidBodyMotion motion = new RigidBodyMotion(
				new double[3]/* ] {Math.random(),Math.random(),Math.random()} */,
		...
		// now apply reconstructed motion to points and see if they match
		// transformedPoints
	...
	public static void SuperposingRotMatrixTest() {
		// Take 2 random points in 3-D, apply a random rotation to them about
		// the origin, then try to reconstruct
		...
		RotationMatrix rot = new RotationMatrix(Math.random(), Math.random(), Math.random(), 360 * Math.random(),
				false);
		...
		RotationMatrix supRot = RotationMatrix.getSuperposingRotMatrix(points[0], transformedPoints[0], points[1],
				transformedPoints[1]);
