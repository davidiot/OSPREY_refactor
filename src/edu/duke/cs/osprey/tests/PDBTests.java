...
public class PDBTests {
	...
	public static void testPDBReadWrite() {
		...
		EnvironmentVars.assignTemplatesToStruct = false;// this would create
		...
		try {
			int diffState = Runtime.getRuntime().exec("diff 1CC8.copy.pdb testResults/1CC8.copy2.pdb").getInputStream()
					.read();
			...
			System.err.println("IO EXCEPTION DURING DIFF");
			e.printStackTrace();
		}
	}
}
