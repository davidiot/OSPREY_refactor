...
public class FreeDihedral extends DegreeOfFreedom {
	// This is a dihedral that can move freely without any compensating motions
	// or motions of other residues
	...
	public void apply(double paramVal) {
		...
		// get indices of all the atoms that are moved by the dihedrals (i.e.,
		// everything beyond the third atom)
		...
		double curDihedralVal = Protractor.measureDihedral(curCoords);// could
																		// go
																		// faster
																		// by
																		// not
