...
public class RigidBodyMotion {
	...
	public RigidBodyMotion(double[] center, double[] axis, double angle, boolean angleInRadians) {
		// rotate about center with the specified axis and angle (in degrees or
		// radians as specified)
		center1 = center;
		center2 = center;
	...
	public RigidBodyMotion(double[][] initCoords, double[][] finalCoords) {
		// we're given three sets of 3-D coordinates, in an initial and a final
		// state
		// we superimpose them, matching the first pair of coordinates exactly,
		// then the direction for the
	...
	public void transform(double[] concatCoords) {
		// given a bunch of concatenated 3D vectors, apply the transformation to
