...
public class VectorAlgebra {
	...
	public static double distance(double[] coords1, int atNum1, double[] coords2, int atNum2) {
		// we're given two arrays of coordinates (concatenated 3-D coordinates
		// of atoms)
		// get the distance between the atoms numbered atNum1 in coords1 and
		// atNum2 in coords2
		double dx = coords1[3 * atNum1] - coords2[3 * atNum2];// difference in x
																// coordinates
																// between the
																// two atoms
	...
	public static double[] parallelComponent(double[] vec1, double[] vec2) {// Component
																			// of
																			// vec1
																			// parallel
																			// to
	...
	public static double[] perpendicularComponent(double[] vec1, double[] vec2) {// Component
																					// of
																					// vec1
																					// perpendicular
																					// to
	...
	public static double[] getPerpendicular(double vec[]) {// Generate a vector
															// perpendicular to
															// the argument
		if (vec[1] == 0 && vec[2] == 0) {
			double yhat[] = { 0, 1, 0 };
	...
	public static double[] average(double v1[], double v2[]) {// Average two
																// vectors
	...
	/**
	 * From KiNG's driftwood.r3.Builder: Given three points A, B, and C,
	 * construct a line segment from C to D of length len at angle ang to BC (in
	 * degrees, 0 to 180) and with a dihedral angle dihe to ABC (in degrees)
	 * return D Used in sidechain idealization
	 */
	...
	// i.e. coord[i][2] = coeffs[0] + coeffs[1]*coord[i][0] +
	// coeffs[2]*coord[i][1] for i=0,1,2
	public static double[] get2DLinCoeffs(double coord[][]) {

		double[] coeffs = new double[3];

		double det = (coord[0][1] - coord[1][1]) * (coord[1][0] - coord[2][0])
				- (coord[1][1] - coord[2][1]) * (coord[0][0] - coord[1][0]);
		// determinant of coefficients from eliminating coeffs[0]. Must be
		// nonzero for nonsingular problems
